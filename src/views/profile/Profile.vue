        ...
        <v-col cols="12">
          <form>
            <v-row>
              ...
              <v-col cols="8">
                <v-text-field v-model="name" :error-messages="nameErrors" :counter="nameCounter" @input="$v.name.$touch()" @blur="$v.name.$touch()"></v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="1">
              ...
              <v-col cols="8">
                <v-text-field v-model="username" :error-messages="usernameErrors" :counter="usernameCounter" @input="$v.username.$touch()" @blur="$v.username.$touch()"></v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="1">
              ...
              <v-col cols="8">
                <v-text-field v-model="email" :error-messages="emailErrors" @input="$v.email.$touch()" @blur="$v.email.$touch()"></v-text-field>
              </v-col>
            </v-row>
            <v-row>
              <v-col cols="1">
              ...
              <v-col cols="8">
                <v-text-field v-model="role" :error-messages="roleErrors" @input="$v.role.$touch()" @blur="$v.role.$touch()" disabled></v-text-field>
              </v-col>
            </v-row>
            <v-row class="mb-2">
              <v-col>
