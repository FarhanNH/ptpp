  ...
  <v-container fluid>
    ...
    <v-card class="pl-8" color="white">
      ...
      <v-row>
        ...
        <v-col cols="8">
          <v-text-field v-model="name" :error-messages="nameErrors" outlined @input="$v.name.$touch()" @blur="$v.name.$touch()"></v-text-field>
        </v-col>
      </v-row>
      <v-row>
        <v-col cols="1">
        ...
        <v-col cols="8">
          <v-text-field v-model="username" :error-messages="usernameErrors" outlined @input="$v.username.$touch()" @blur="$v.username.$touch()"></v-text-field>
        </v-col>
      </v-row>
      <v-row>
        <v-col cols="1">
        ...
        <v-col cols="8">
          <v-text-field v-model="email" :error-messages="emailErrors" outlined @input="$v.email.$touch()" @blur="$v.email.$touch()"></v-text-field>
        </v-col>
      </v-row>
      <v-row>
        <v-col cols="1">
        ...
        <v-col cols="8">
          <v-select v-model="roleCode" :items="roleOption" :error-messages="roleErrors" placeholder="Pilih Role" outlined required @change="$v.roleCode.$touch()" @blur="$v.roleCode.$touch()"></v-select>
        </v-col>
      </v-row>
      <v-row>
        <v-col cols="6">
